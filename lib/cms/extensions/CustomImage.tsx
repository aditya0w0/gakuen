    ...
    <NodeViewWrapper className="relative my-4">
      ...
      >
        ...
        {!showPromptInput && !isUploading && (
          <div
            className={`absolute inset-0 bg-black/40 ${hasImage ? 'opacity-0 group-hover:opacity-100' : 'opacity-100'} transition-opacity flex items-center justify-center gap-4 backdrop-blur-sm rounded-xl`}
          >
            {/* Upload Button */}
            <div
