    ...
    <div className="max-w-4xl mx-auto px-8 py-6 space-y-6">
      ...
      <div>
        ...
        <div className="relative w-full h-64 bg-zinc-800 rounded-xl overflow-hidden group">
          ...
          {courseThumbnail &&
          courseThumbnail !== 'https://placehold.co/800x400' &&
          !thumbnailError ? (
            ...
            <div
              ...
              title={
                thumbnailError ? 'Click to retry loading image' : undefined
              }
            >
          ...
          {showPrompt && (
            <div
              className="absolute inset-0 bg-zinc-900/95 flex flex-col items-center justify-center p-6 z-10"
      ...
      <div>
        ...
        <p className="text-xs text-zinc-500 mt-2">
          Click the avatar to upload a custom instructor image
        </p>
      </div>
